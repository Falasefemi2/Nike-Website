        ...
        >
          <div className="grid items-center justify-items-center mt-28 md:mt-24">
            ...
            <motion.div
              ...
              className="grid items-center absolute top-[33vh] lg:top-[27vh] right-0 gap-3"
            >
          ...
          >
            <motion.img
              ...
              src={img}
              alt="hero-img/img"
              className="w-auto h-[45vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] transitions-theme cursor-pointer object-fill"
            />
          </motion.div>
        </motion.div>
      </div>
